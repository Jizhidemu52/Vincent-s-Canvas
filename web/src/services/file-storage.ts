...
/** Release video/audio object URLs not visible in the current workspace without deleting local files. */
export function releaseUnusedMediaObjectUrls(usedData: unknown) {
    releaseUnusedObjectUrls(objectUrls, collectMediaStorageKeys(usedData));
}
