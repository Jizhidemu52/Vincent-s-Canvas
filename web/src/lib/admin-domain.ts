...
export function createDefaultAdminState(now = new Date().toISOString()): AdminState {
    return {
        ...
        models: [
            ...
            { id: "sflxjj", name: "四方连续进阶", modelId: "sflxjj", provider: "内部 AI", capabilities: ["edit"], credits: 0, rmbCost: 0, enabled: true },
        ],
        ledger: [],
        history: [],
        materials: [],
        ...
        normalizeApiProvider(
            {
                ...
                imageGenerationEndpoint: "",
                imageEditEndpoint: "/std/comfy_generate",
                enabled: true,
                primary: false,
                volcengineProjectName: "",
                volcengineRegion: "",
                models: [createProviderModel("sflxjj", "四方连续进阶", "image", ["edit"], 2, 0, 35)],
                loras: [],
                runningHubEntries: [],
