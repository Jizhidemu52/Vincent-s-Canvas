...
function PromptPreviewImage({ prompt }: { prompt: Prompt }) {
    if (!prompt.coverUrl) {
        return <div className="flex aspect-[4/3] w-full items-center justify-center rounded-lg bg-orange-50 text-xs font-medium text-orange-700 dark:bg-stone-900 dark:text-orange-300">暂无封面</div>;
    }
    return <img src={prompt.coverUrl} alt={prompt.title} className="aspect-[4/3] w-full rounded-lg object-cover" />;
}
                    ...
                    <>
                        <div className="grid gap-5 md:grid-cols-[300px_minmax(0,1fr)]">
                            <div className="space-y-3">
                                <PromptPreviewImage prompt={prompt} />
