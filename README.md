...
| 身份 | 进入哪里 | 能看到什么 | 不能做什么 |
| --- | --- | --- | --- |
| 设计师 | 设计师工作台 | 项目、文生图、细节增强、图片编辑、角度控制、无缝拼接、视频创作、提示词库、素材库、GPT 对话、无线画布 | 看不到后台管理、API 设置、额度调控、价格配置 |
| 管理员 | 后台管理 | 账号额度、积分价格、API Provider、工作流、模型 API、历史记录、项目素材、批量任务、审计日志 | 拥有最高权限 |
...
如果你已经让 Codex 帮你启动了项目，直接打开上面的地址就行。
