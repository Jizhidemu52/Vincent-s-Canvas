...
3. Expand basketikun-style asset and prompt organization with prompt categories, favorites, richer card metadata, and deeper image storage boundaries now that asset folders/search/filtering and prompt detail handoff exist.
