...
1. Continue migrating T8-style typed settings schemas so config nodes can carry provider options and other structured module parameters beyond output count, edit masks, and batch concurrency/failure policy.
