...
- Hero-inspired admin team history filtering plus filtered JSON/CSV export for audit and finance handoff.
...
| History bulk management | `hero8152/Infinite-Canvas` | `static/js/history-bulk-manager.js` | Adapted filtered admin team history JSON/CSV export and designer-side project history filtering on 2026-06-28 so managers and designers can trace generation records by account/project; bulk selection and delete/archive operations remain later. |
...
4. Use hero history bulk management ideas for admin/team history bulk selection and archive/delete operations after real provider output storage is stable.
