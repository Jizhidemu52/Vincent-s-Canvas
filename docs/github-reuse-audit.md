...
3. Expand basketikun-style prompt organization with categories, favorites, and richer prompt card metadata now that detail cards and canvas-note handoff exist.
