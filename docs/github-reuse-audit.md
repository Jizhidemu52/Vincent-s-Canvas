...
1. Extend the current T8-inspired batch queue with real async worker concurrency, pause/resume, stop-on-failure execution, and persistent provider job progress after live provider execution is connected.
