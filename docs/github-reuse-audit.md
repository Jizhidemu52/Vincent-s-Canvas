...
1. Continue migrating T8-style typed config/image input execution so workflow modules can consume connected config/image ports with the same behavior now used for connected text prompts.
