...
1. Continue migrating T8-style typed input execution so workflow modules can consume connected text/config/image ports, not only draw the typed connections.
