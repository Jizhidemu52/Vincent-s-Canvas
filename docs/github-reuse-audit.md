...
| History bulk management | `hero8152/Infinite-Canvas` | `static/js/history-bulk-manager.js` | Adapted filtered admin team history JSON/CSV export, selected-row CSV export, and designer-side project history filtering on 2026-06-28 so managers and designers can trace generation records by account/project; delete/archive operations remain later. |
