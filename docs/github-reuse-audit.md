...
1. Continue migrating T8-style typed config input execution so workflow modules can consume connected mask/batch settings ports with the same behavior now used for connected text prompts and image references.
