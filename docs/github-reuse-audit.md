...
1. Continue migrating T8-style typed settings schemas so config nodes can carry edit masks, batch concurrency, provider options, and other structured module parameters beyond output count.
